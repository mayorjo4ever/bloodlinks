...
<body>
	...
	<section>
		...
		<p> Testing Temperature </p>
			<?php 
			$simpleTemp = new Convertor(37, "c"); ?>
			<pre> <?php 
				print_r($simpleTemp->toAll());
				# echo(json_encode($simpleTemp->Units("m"), JSON_PRETTY_PRINT));?>
	...
	<section>
		...
		<p> Testing Time </p>
			<?php 
			$sample = new Convertor(6, "month"); ?>
			<pre> <?php 
				print_r($sample->toAll());
				# echo(json_encode($simpleTemp->Units("m"), JSON_PRETTY_PRINT));?>
...
$simpleConvertor->to("ft"); //returns converted value</pre>
        ...
        $simpleConvertor = new Convertor(120, "m");
		?>

		<p>120 Meters = <?php echo($simpleConvertor->to("ft")); ?> Feet</p>
...
$multiunitConvertor->to("ft"); //returns converted value in feet</pre>
		<?php
			$multiunitConvertor = new Convertor(1000, "m");
		?>
...
$multiunitConvertor->to(["km","ft","in"]); //returns an array of converted values in kilometers, feet and inches</pre>
		...
		<pre><?php echo(json_encode($multiunitConvertor->to(["km","ft","in","yd"]), JSON_PRETTY_PRINT));?></pre>
	</section>
...
$getUnitsConvertor->getUnits("m"); //returns converted value</pre>
		...
		<pre><?php echo(json_encode($getUnitsConvertor->Units("m"), JSON_PRETTY_PRINT));?></pre>
