<?php
	...
	class DbTool{
			...
			public function __construct(){
		      ...
		      $this->username = 'root';	  
			  $this->psw = 'mayoskele'; #  connection to db 						
			...
			try{
				...
				$this->conn = new PDO('mysql:host=127.0.0.1; dbname=hrm_db',$this->username,$this->psw);
	...
	// make crypting
		...
		function decodeId($id){
		 ...
		 public function clean($text,$type='string'){
			 if($type=='string') return filter_var($text,FILTER_SANITIZE_STRING); 			
