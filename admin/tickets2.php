                ...
                <div class="card">
                  <div class="card-body" style="height:auto">
					...
					<ul class="nav nav-tabs tab-solid tab-solid-info tab-seperated bold" role="tablist">
						...
						<li class="nav-item " >
							<a  class="nav-link active" id="tab1" data-toggle="tab" href="#stock-tab1" role="tab" aria-controls="stock-tab1" aria-selected="false"> Pending Tickets  </a>
						  </li> <!-- add event -- onclick="save_active_tab('tab4','stock')"  -->
						  
						  <li class="nav-item" >
							<a class="nav-link " id="tab2" data-toggle="tab" href="#stock-tab2" role="tab" aria-controls="stock-tab2" aria-selected="false">  Completed Tickets  </a>
						  </li>  
					  </ul>
