...
(function ($) {
    ...
    $(function () {
        ...
        var lightColor = getComputedStyle(document.body).getPropertyValue('--light');
          ...
          var areaData = {
            labels:["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], ///["2013", "2014", "2015", "2016", "2017"],
            datasets: [{
              label: '# Amounts',
              data:  <?php expected_pays( $chart_year);  ?>,// [12, 19, 3, 5, 2, 3],
              backgroundColor: [
                'rgba(255, 99, 132, 0.2)',
                'rgba(54, 162, 235, 0.2)',
                'rgba(255, 206, 86, 0.2)',
        ...
        <?php  $payment = payment_summary($chart_year); ?>
         var c3paid = <?php  echo $payment['paid']; ?>;
         var c3balance = <?php  echo $payment['balance']; ?>;
         var c3discount = <?php  echo $payment['discount']; ?>;
          var c3DonutChart = c3.generate({
                ...
                color: {
                  pattern: ['rgba(88,216,163,1)', 'rgba(255,255,0,0.8)', 'rgba(237,28,36,0.6)']
                },
                padding: {
                  top: 0,
                  right: 0,
                ...
                donut: {
                  title: "<?php echo $chart_year;?> Payment"
                }
              });
        ...
        if ($('#statistics-graph-2').length) {
            ...
            var lineChart = new Chart(lineChartCanvas, {
                type: 'line',
                data: {
                    labels: <?php echo json_encode($week_payment['days'])?>, //["Day 1", "Day 2", "Day 3", "Day 4", "Day 5", "Day 6", "Day 7"],
                    datasets: [{
                        label: 'Paid',
                        data: <?php echo json_encode($week_payment['dpaid'])?>,//[7, 9, 2, 2, 8, 7, 9],
                        borderColor: primaryColor,
                        backgroundColor: gradientStrokeFill_1,
                        borderWidth: 2,
                        fill: true
        ...
        if ($('#statistics-graph-3').length) {
            ...
            var lineChart = new Chart(lineChartCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                        label: 'Balance', 
                        data: <?php echo json_encode($week_payment['dbalance'])?>,// [5, 4, 7, 2, 9, 2, 8],
        ...
        if ($('#conversionBarChart').length) {
           ...
           // records are fetched from top @line 390
            var barChart = new Chart(barChartCanvas, {
                type: 'bar',
                data: {
                    labels: <?php echo json_encode($week_payment['days']);?>,//["Day 1", "Day 2", "Day 3", "Day 4", "Day 5", "Day 6", "Day 7", "Day 8", "Day 9", "Day 10"],
                    datasets: [{
                        label: 'Amount Collected',
                        data: <?php echo json_encode($week_payment['dpaid']);?>,// [39, 19, 25, 16, 31, 39, 12, 18, 33, 24],
                        backgroundColor: primaryColor
                    }]
                },
                options: {
        ...
        if ($("#realtime-statistics").length) {  
            ...
            var realtimeChart = new Chart(realtimeChartCanvas, {
                ...
                data: {
                    ...
                    datasets: [{
                            label: 'Paid',
                            data: <?php amounts_paid( $chart_year);  ?>,//[330, 380, 230, 400, 309, 530, 340, 400, 490, 380, 300, 510],
                            backgroundColor: primaryColor
                        },
                        {
                            label: 'Target',
                            data: <?php expected_pays( $chart_year); ?>, //[600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600],
