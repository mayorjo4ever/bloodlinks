			...
			<div class="col-md-12 ">
				 <?php  
					...
					if(!is_null($patients))
						{  ?>
					<p class="h4 text-info bold">  <?php  echo count($patients['sn']). " Patients Found  "; ?></p>
							...
							<td> <span class="btn btn-sm btn-rounded btn-default bold"> <?php echo ($n+1); ?> </span> </td>
							 ...
							 <!--
								...
								<div class="btn-group" role="group" aria-label="Basic example">
 								  ...
 								  <a href="" rel="tooltip" onclick=" "  class=" btn btn-light">
									 <i class="fa fa-pencil"> </i>
								</a>  
								<!--
								<button type="submit" name="p_update" title="<?php echo $patients['sn'][$n]; ?>" class="btn btn-light btn-sm" value="<?php echo $patients['sn'][$n]; ?>">  <i class="fa fa-pencil"> </i> </button>
								 
								<a href="" rel="tooltip"  onclick="display_my_sibling($('#sib_view2'),'<?php echo $id; ?>') "  class=" btn btn-inverse-success addSiblings">
