			...
			<div class="row"> 
				...
				<div class="col-md-4 float-left">
					<div class="form-group"> 
							...
							<select name="hosp_id" id="hosp_id" disabled class="hospitals font-16 form-control form-control-lg border border-primary" onchange="console.log($(this).val())"> 
				...
				<div class="col-md-3 float-left param_form all"> 
						<div class="form-group">
							<label for="title" class="col-form-label "> Date From   </label>		 
									<input type="text" id="datefrom" name="datefrom" value="<?php echo $_SESSION['datefrom'] ??""; ?>"  class="datepicker form-control border-primary font-14 imput-sm" placeholder="Date From"> 
							</div> <!-- ./ form-group -->
				   </div> <!-- ./ col-md-5 -->
				   ...
				   <div class="col-md-3 float-left param_form all"> 
					  <div class="form-group">
							<label for="title" class="col-form-label "> Date To   </label>							
								<input type="text" id="dateto" name="dateto" value="<?php echo $_SESSION['dateto'] ??""; ?>" class="datepicker form-control border-primary font-14 imput-sm" placeholder="Date To"> 								 					
					  </div> <!-- ./ form-group -->
				   </div> <!-- ./ col-md-5 -->
				...
				<div class="col-md-4 float-left text_form all"> 
					  <div class="form-group">
							<label for="title" class="col-form-label "> Name / Ticket No   </label>
							  <input type="text" id="invoice_ticket_no" name="invoice_ticket_no" value="" class=" form-control border-primary font-14 imput-sm" placeholder="HRM/20/0001"> 
					  </div> <!-- ./ form-group -->
				...
				<div class="col-md-2 float-left param_form all">
					<div class="form-group">
						<label class="col-form-label "> &nbsp; </label> <br/>
						  <button type="button" for="<?php echo $invoice_no; ?>" class="btn btn-info btn-rounded btn-lg start-invoice-by-param" name="start-invoice-by-param"> Search  &nbsp;   <i class="fa fa-search font-20"></i> </button>
					 </div> <!-- -->
				</div> <!-- col-md-2-->  
