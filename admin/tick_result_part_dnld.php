...
<html lang="en">
   <head>
      <!-- Required meta tags -->
      <?php require "admin_style_link_2.php";?>   <!-- 
                  ...
                  <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 ">
                     <div class="card d-flex">
                        <div class="card-body" style="height:auto">
                           <?php $bg_image = $dbm->resort($dbm->getFields($dbm->select('system_info',array('')),array('header_image','footer_image','signatory_image','manager')));?>
                           <p style="height:135px;" class="bg-header"><img src="<?php echo "../assets/images/".$bg_image['header_image'];?>" /></p>
                           <?php 
                              ...
                              $custom_info = $dbm->getFields($dbm->select('customer_tickets',$criterial),$mydal->TableFields('customer_tickets'));
                               ...
                               $my_ticket_invoice = $dbm->getFields($dbm->select('hospital_invoice',array('ticket_no'=>$ticket_no)),$mydal->TableFields('hospital_invoice'));
                               /*****************************************/
                              	if($custom_ticket_id['payment_finalized']=="no" && empty($my_ticket_invoice)){
                              	...
                              	$customer_id =  $custom_ticket_id['customer_id'];		
                                $bill_name ="";
                           ...
                           <table class="table-btop table-nogap  table  cosmo border-none line-35" >
                              <tbody>
                                 <tr class="text-capitalize no-padding no-margin">
                                    <td > <span class="bold"> Patient's Name : </span> &nbsp;&nbsp; <?php echo $custom_ticket_id['fullname']; ?>  </td>
                                    <td> <span class="bold">  Age : </span> &nbsp;&nbsp;<?php echo getAge($custom_ticket_id['age_text'],$custom_ticket_id['date_c']." ".$custom_ticket_id['time_c']); ?>   </td>
                                    <td> <span class="bold">  Sex : </span> &nbsp;&nbsp;<?php echo $custom_ticket_id['sex']; ?></td>
                                 </tr>
                                 <tr class="text-capitalize no-padding no-margin ">
                                    <td colspan="3"> <span class="bold">   Clinical details : </span> &nbsp;&nbsp; &nbsp;&nbsp;<?php   echo $custom_ticket_id['clinical_details']; ?>    </td>
                                 </tr>
                                 <tr class="text-capitalize no-padding no-margin">
                                    <td colspan="3">  <span class="bold">  Referred by : </span> &nbsp;&nbsp; &nbsp;&nbsp;<?php echo $custom_ticket_id['doctor']; ?>  </td>
                                 </tr>
                                 <tr class="text-capitalize no-padding no-margin">
                                    <td colspan="3">  <span class="bold">  Referrer’s Address : </span>&nbsp;&nbsp; &nbsp;&nbsp;<?php echo $custom_ticket_id['hospital']; ?></td>
                                 </tr>
                           ...
                           <table class="table-btop table-nogap  table  cosmo border-none line-35 " style="border-top:5px #000 thick;" >
                              <tbody>
                                 <tr class="text-capitalize no-padding no-margin" >
                                    ...
                                    <td> <span class="bold">  Specimen Type : </span> &nbsp;&nbsp;<?php echo $specimens['specimen_sample'][0];  ?></td>
                                 </tr>
                                 <tr class="text-capitalize no-padding no-margin">
                                    <td colspan="2"> <span class="bold">  Date Collected: </span> &nbsp;&nbsp; &nbsp;&nbsp;<?php echo date('d/m/y',strtotime($custom_ticket_id['date_c']));  ?>  </td>
                                    <td colspan=""> <span class="bold">  Date Received: </span> &nbsp;&nbsp; &nbsp;&nbsp;<?php echo date('d/m/y',strtotime($custom_ticket_id['date_c']));  ?>  </td>
                                 </tr>
                                 <tr class="text-capitalize no-padding no-margin">
                                    <td colspan="2" style="white-space:-o-pre-wrap; white-space:break-word; white-space:pre-wrap; white-space:pre-wrap;"><span class="bold">Test(s) Performed:</span>  <?php echo ($custom_ticket_id['alt_test_name']=="")?$bill_name:$custom_ticket_id['alt_test_name']; ?>  </td>
                                 </tr>
                                 <tr class="text-capitalize no-padding no-margin dark-bottom-border">
                                    <td colspan="3">  <span class="bold"> Date Performed:    </span>&nbsp;&nbsp; &nbsp;&nbsp; <?php echo date('d/m/y',($custom_ticket_id['date_fin']=="")? strtotime(date('Y-m-d')): strtotime($custom_ticket_id['date_fin'])); ?></td>
                                 </tr>
                              </tbody>
                              <!--
                                 <tbody>
                                 	...
                                 	<tr class="text-capitalize no-padding no-margin"> <td colspan="2" style="white-space:-o-pre-wrap; white-space:break-word; white-space:pre-wrap; white-space:pre-wrap;"><span class="bold">Test(s) Performed:    </span> &nbsp;&nbsp; &nbsp;&nbsp; <?php echo ($custom_ticket_id['alt_test_name']=="")?$bill_name:$custom_ticket_id['alt_test_name']; ?>  </td> </tr>											
                                 	<tr class="text-capitalize no-padding no-margin dark-bottom-border"> <td colspan="3">  <span class="bold">   Performed Date:    </span>&nbsp;&nbsp; &nbsp;&nbsp; <?php echo date('d/m/y',($custom_ticket_id['date_fin']=="")?time(): strtotime($custom_ticket_id['date_fin'])); ?></td>  </tr>							
                                 </tbody> -->
                           </table>
                           <?php 
                              /*******************************/
                           ...
                           <p class="cosmo" style="font-size:32px; color:red; ">   <?php echo ($custom_ticket_id['comment']!="")?"<hr/> <b> COMMENT : </b>&nbsp;&nbsp;&nbsp;".$custom_ticket_id['comment']:""; ?>  </p>
                           <hr/>
