          ...
          <div class="row" id="">
			<div class="col-lg-6 grid-margin stretch-card">
              <div class="card">               
                <div class="card-body">                    
				 <div class="col-md-12">
					<span class="h3 text-capitalize "> <i class="fa fa-comment text-success"> </i> &nbsp; add comments </span> <p>&nbsp; </p>				 					
					</div> <!-- ./ col-md-10 div -->
					 
					<div class="col-md-12" id=""> 
						 <form method="post">
						<?php require "conversation_form2.php";?>
						</form>		
                ...
                <div class="card-body">                    
				 <div class="col-md-12"> 
					<span class="h3 text-capitalize"> 
						...
						<!--	<a href="" class="btn btn-success text-capitalize"> create new report &nbsp;  <span class="fa fa-comment"></span> </a> -->
						<p>   </p> 
