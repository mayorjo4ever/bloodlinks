<?php 
		...
		set_time_limit(0); print "<pre>";
		
		/** **/
		
		$all_bills = $mydbm->runBaseQuery("select * from customer_specimen where date_c  BETWEEN '2022-01-01' and  '2022-01-05'  and status='active' group by ticket_no"); 
		// $tsum = 0;
		print_r($all_bills); 
