  ...
  <div class="container d-flex flex-row nav-top">
    <div class="text-center navbar-brand-wrapper d-flex align-items-top">
      <a class="navbar-brand brand-logo" href="index.php">
        <img src="../assets/images/logo_2.svg" alt="logo" /> </a>
      ...
      <ul class="navbar-nav ml-auto"> <!--
        ...
        <li class="nav-item dropdown d-none d-xl-inline-block">
          <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">Hello, <?php echo $_SESSION['adminFullname'];  ?>
            <img class="img-xs rounded-circle ml-3" src="../assets/images/faces/face8.jpg" alt="Profile image"> </a>
    ...
    <div class="container">
      <ul class="nav page-navigation">
	   ...
	   <li class="nav-item mega-menu">
		...
		<li class="nav-item">
          <a href="#" class="nav-link">
            <i class="link-icon mdi mdi-layers"></i>
          ...
          <div class="submenu ">
            <ul class="submenu-item ">
              <li class="nav-item ">
                <a class="nav-link " href="newstock.php">New Stocks</a>
              </li>
			  
			  <li class="nav-item ">
                <a class="nav-link " href="stocks.php">View Stocks</a>
              </li>
              
              <li class="nav-item ">
                <a class="nav-link " href="vendors.php ">Stock Vendors </a>
              </li>
            </ul>
          </div>
        </li> 
		...
		<li class="nav-item">
          ...
          <div class="submenu ">
            <ul class="submenu-item ">
              <li class="nav-item ">
                <a class="nav-link " href="new_sales.php"> New Sales </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="sales_reports.php "> View Sales Report </a>
              </li> 
            </ul>
          </div>
        </li> 
		...
		<li class="nav-item">
          <a href="#" class="nav-link">
            <i class="link-icon fa fa-bar-chart-o"></i>
          ...
          <div class="submenu ">
            <ul class="submenu-item ">
              <li class="nav-item ">
                <a class="nav-link " href="pages/apps/email.html "> Sales Reports </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="pages/apps/calendar.html "> Products Expiration </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="pages/apps/todo.html "> Users Priviledges </a>
              </li>
              <li class="nav-item ">
		...
		<li class="nav-item">
          ...
          <div class="submenu ">
            <ul class="submenu-item ">
              <li class="nav-item ">
                <a class="nav-link " href="pages/apps/email.html "> Company Details </a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="pages/apps/calendar.html "> Users Management</a>
              </li>
              <li class="nav-item ">
                <a class="nav-link " href="priviledges.php"> Users Priviledges </a>
              </li>
              
              <li class="nav-item ">
                <a class="nav-link " href="stock_config.php"> Stock Settings </a>
              </li>
