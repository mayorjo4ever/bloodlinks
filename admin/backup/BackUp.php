...
class BackUp {
    ...
    function backup($tablename = null, $dir = null, $size = null) {
        ...
        if ( $tablename ) {
            ...
            // 
            $filename = $database."_".date ( 'Y-m-d, H-i-s' );
            // 
            ...
            $sql .= $this->_retrieve ();
            // 
            $filename = $this->database."_@".date ('Y_m_d@H_i_s_A' ) . "_full";
            // 
    ...
    private function _retrieve() {
        ...
        $value .= '-- '.$this->lang['build_date'].': ' . date('M d, Y') .' at '.date('H:i A') . $this->ds;
        $value .= '-- Server version: ' . mysqli_get_server_info ($this->conn) . $this->ds;
